...
# Asteroids
ASTEROID_IMAGES = [
    pygame.image.load(os.path.join("assets", "sci.jpg")),
    pygame.image.load(os.path.join("assets", "sci.jpg")),
    pygame.image.load(os.path.join("assets", "sci.jpg")),
]

# Gems
GEM_IMAGE = pygame.image.load(os.path.join("assets", "stem.jpg"))
...
class Player(Ship):
    ...
    def draw_score(self, window):
        score_label = pygame.font.SysFont("comicsans", 30).render("Score: " + str(self.score), 1, (255, 255, 255))
